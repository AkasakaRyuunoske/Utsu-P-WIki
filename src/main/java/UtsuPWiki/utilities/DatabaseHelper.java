            ...
            try {
                ...
                * */
                ...
                if (doPopulateProducts.equals("true") || doPopulateAll.equals("true")) {
                    data_sqlWriter.write("INSERT INTO Products(id, cost, product_name, quantity, genres_id_fk, date_out, author_id_fk, types_id_fk, product_image, contains) VALUES(1, 9.49, \"Utsu-P - Diarrhea\", 0, 1, \"15/11/2009\", 1, 1, \"https://i.scdn.co/image/ab67616d00001e02486835908dacc4ca95d5a7e4\", \"Poison Apple, Anti Digitalizm, Melancholly of Heavy Rain, Self-Distruct\");                                        \n");
                    data_sqlWriter.write("INSERT INTO Products(id, cost, product_name, quantity, genres_id_fk, date_out, author_id_fk, types_id_fk, product_image, contains) VALUES(2, 9.49, \"Utsu-P - Traumatic\", 0, 1, \"14/11/2010\", 1, 1, \"https://pbs.twimg.com/media/FIcD_F7VEAAGOoN.jpg\", \"Contipation of Death, Children's World, Adult's Toy, THE DYING MESSAGE\");                                                                            \n");
                    data_sqlWriter.write("INSERT INTO Products(id, cost, product_name, quantity, genres_id_fk, date_out, author_id_fk, types_id_fk, product_image, contains) VALUES(3, 8.99, \"Utsu-P - Moksha\", 0, 1, \"30/04/2012\", 1, 1, \"https://static.zerochan.net/Type-H.full.1118182.jpg\", \"Fools are Attracted to Anomaly, Rebirth, Corona, Striped Melody\");                                                                           \n");
                    data_sqlWriter.write("INSERT INTO Products(id, cost, product_name, quantity, genres_id_fk, date_out, author_id_fk, types_id_fk, product_image, contains) VALUES(4, 10.99, \"Utsu-P - CD-R\", 0, 1, \"07/07/2013\", 1, 1, \"https://2.bp.blogspot.com/-NADgzcUVVUk/Vd4KDsYlY_I/AAAAAAAACfk/UTiAT4Qyrq0/s1600/Cover.jpg\", \"Corpse Attack!!, Disparate Society, Initiative, Psychokinesis\");                                     \n");
                    data_sqlWriter.write("INSERT INTO Products(id, cost, product_name, quantity, genres_id_fk, date_out, author_id_fk, types_id_fk, product_image, contains) VALUES(5, 20.60, \"Utsu-P - Warufuzake\", 0, 1, \"07/08/2013\", 1, 1, \"https://1.bp.blogspot.com/-ZkrdobPmUhA/Vd4LYrm62DI/AAAAAAAACfw/7htWgnJbHCE/s1600/Cover.jpg\", \"Impli-Cat Understanding, Ghost Under the Umbrella, Painting, B-Class Heroes\");                               \n");
                    data_sqlWriter.write("INSERT INTO Products(id, cost, product_name, quantity, genres_id_fk, date_out, author_id_fk, types_id_fk, product_image, contains) VALUES(6, 9.49, \"Utsu-P - Algorithm\", 0, 1, \"17/08/2014\", 1, 1, \"https://pbs.twimg.com/media/FIcD_FuUYAYCpAb.jpg\", \"\");                                                                            \n");
                    data_sqlWriter.write("INSERT INTO Products(id, cost, product_name, quantity, genres_id_fk, date_out, author_id_fk, types_id_fk, product_image, contains) VALUES(7, 9.49, \"Utsu-P - Post-Traumatic-Stress-Disorder\", 0, 1, \"10/08/2016\", 1, 1, \"https://yt3.ggpht.com/ytc/AKedOLSZDJ0kM5zXdip49BsNbamj_FTTfIZRpy_CU6ATrg=s900-c-k-c0x00ffffff-no-rj \", \"none\");  \n");
                    data_sqlWriter.write("INSERT INTO Products(id, cost, product_name, quantity, genres_id_fk, date_out, author_id_fk, types_id_fk, product_image, contains) VALUES(8, 7.92, \"Utsu-P - Galapagos\", 0, 1, \"11/08/2017\", 1, 1, \"http://p1.music.126.net/qVr09TyAqDjM4cjAHoT7KA==/109951164983684976.jpg  \", \"none\");                                                  \n");
                    data_sqlWriter.write("INSERT INTO Products(id, cost, product_name, quantity, genres_id_fk, date_out, author_id_fk, types_id_fk, product_image, contains) VALUES(9, 9.49, \"Utsu-P - Greatest Shits\", 0, 1, \"10/08/2018\", 1, 1, \"https://pbs.twimg.com/media/Dno97nqW0AIuoOM.jpg:large \", \"none\");                                                                \n");
                    data_sqlWriter.write("INSERT INTO Products(id, cost, product_name, quantity, genres_id_fk, date_out, author_id_fk, types_id_fk, product_image, contains) VALUES(10, 7.92, \"Utsu-P - Renaissance\", 0, 1, \"10/08/2019\", 1, 1, \"http://p1.music.126.net/MLtANLgzgnIkW_xV4TZQ4Q==/109951164983692215.jpg   \", \"none\");                                              \n");
                    data_sqlWriter.write("INSERT INTO Products(id, cost, product_name, quantity, genres_id_fk, date_out, author_id_fk, types_id_fk, product_image, contains) VALUES(11, 9.49, \"Utsu-P - Unique\", 0, 1, \"23/10/2021\", 1, 1, \"https://pbs.twimg.com/media/FEu7iZNXwA4Dy-U.jpg\", \"none\" ); \n");
