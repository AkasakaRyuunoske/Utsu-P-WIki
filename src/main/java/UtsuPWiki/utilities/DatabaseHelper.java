            ...
            try {
                ...
                * */
                ...
                if (doPopulateProducts.equals("true") || doPopulateAll.equals("true")) {
                    data_sqlWriter.write("INSERT INTO Products(id, cost, product_name, quantity, genres_id_fk, date_out, author_id_fk, types_id_fk, product_image, contains, link_spotify) VALUES(1, 9.49, \"Utsu-P - Diarrhea\", 0, 1, \"15/11/2009\", 1, 1, \"https://i.scdn.co/image/ab67616d00001e02486835908dacc4ca95d5a7e4\", \"Anti Digitalizm, Melancholy of Heavy Rain, Psychokinesis, Self-Destruct\", \"https://open.spotify.com/album/3WrPMnsYqOsqbYBHeEqURI?si=wK9MrmqWT5izzAtnkWLzsA\");                                        \n");
                    data_sqlWriter.write("INSERT INTO Products(id, cost, product_name, quantity, genres_id_fk, date_out, author_id_fk, types_id_fk, product_image, contains, link_spotify) VALUES(2, 9.49, \"Utsu-P - Traumatic\", 0, 1, \"14/11/2010\", 1, 1, \"https://pbs.twimg.com/media/FIcD_F7VEAAGOoN.jpg\", \"Constipation of Death, Monkey Doesn't know, Vermin, Black Showtime\", \"\");                                                                            \n");
                    data_sqlWriter.write("INSERT INTO Products(id, cost, product_name, quantity, genres_id_fk, date_out, author_id_fk, types_id_fk, product_image, contains, link_spotify) VALUES(3, 8.99, \"Utsu-P - Moksha\", 0, 1, \"30/04/2012\", 1, 1, \"https://static.zerochan.net/Type-H.full.1118182.jpg\", \"Riot, Black Hole Artist, Red light green light?, Shima Shima Melody\", \"https://open.spotify.com/album/5wdMRoZgCmQIXq1wcOBmb9?si=Z-E_-5U9R2u1o46nW1FHSw\");                                                                           \n");
                    data_sqlWriter.write("INSERT INTO Products(id, cost, product_name, quantity, genres_id_fk, date_out, author_id_fk, types_id_fk, product_image, contains, link_spotify) VALUES(4, 10.99, \"Utsu-P - CD-R\", 0, 1, \"07/07/2013\", 1, 1, \"https://2.bp.blogspot.com/-NADgzcUVVUk/Vd4KDsYlY_I/AAAAAAAACfk/UTiAT4Qyrq0/s1600/Cover.jpg\", \"Corpse Attack!!, Disparate Society, Welcome to the Love Hospital, DIARRHEA\", \"\");                                     \n");
                    data_sqlWriter.write("INSERT INTO Products(id, cost, product_name, quantity, genres_id_fk, date_out, author_id_fk, types_id_fk, product_image, contains, link_spotify) VALUES(5, 20.60, \"Utsu-P - Warufuzake\", 0, 1, \"07/08/2013\", 1, 1, \"https://1.bp.blogspot.com/-ZkrdobPmUhA/Vd4LYrm62DI/AAAAAAAACfw/7htWgnJbHCE/s1600/Cover.jpg\", \"Fools Are Attracted to Anomaly, Ghost Under the Umbrella, Painting, B-Class Heroes\", \"\");                               \n");
                    data_sqlWriter.write("INSERT INTO Products(id, cost, product_name, quantity, genres_id_fk, date_out, author_id_fk, types_id_fk, product_image, contains, link_spotify) VALUES(6, 9.49, \"Utsu-P - Algorithm\", 0, 1, \"17/08/2014\", 1, 1, \"https://pbs.twimg.com/media/FIcD_FuUYAYCpAb.jpg\", \"A final fantasy, ALGORITHMIC KABUKICHO, P.O.R.N.O., Hell Pops\", \"https://open.spotify.com/album/1hJOEeJGzToyBsM6eQ5M8I?si=Y4yUAi9BQCKOqN-aovem7g\");                                                                            \n");
                    data_sqlWriter.write("INSERT INTO Products(id, cost, product_name, quantity, genres_id_fk, date_out, author_id_fk, types_id_fk, product_image, contains, link_spotify) VALUES(7, 9.49, \"Utsu-P - Post-Traumatic-Stress-Disorder\", 0, 1, \"10/08/2016\", 1, 1, \"https://yt3.ggpht.com/ytc/AKedOLSZDJ0kM5zXdip49BsNbamj_FTTfIZRpy_CU6ATrg=s900-c-k-c0x00ffffff-no-rj \", \"Constipation of Death, Children's World, Adult's Toy, THE DYING MESSAGE\", \"https://open.spotify.com/album/7ex8PWSObIK1VQsUpixjnC?si=pHioVDaaSHS8NMOpm4lc9A\");  \n");
                    data_sqlWriter.write("INSERT INTO Products(id, cost, product_name, quantity, genres_id_fk, date_out, author_id_fk, types_id_fk, product_image, contains, link_spotify) VALUES(8, 7.92, \"Utsu-P - Galapagos\", 0, 1, \"11/08/2017\", 1, 1, \"http://p1.music.126.net/qVr09TyAqDjM4cjAHoT7KA==/109951164983684976.jpg  \", \"Is it bad at the Galapagos Syndrome?, Sugarcoat of Love, Ramen shop 'GROTESQUE', Summer Vacation in the Future\", \"https://open.spotify.com/album/2SbwUk0WexA476H2UklLhe?si=LA1Z6_02Sea8XUuvTjPrVA\");                                                  \n");
                    data_sqlWriter.write("INSERT INTO Products(id, cost, product_name, quantity, genres_id_fk, date_out, author_id_fk, types_id_fk, product_image, contains, link_spotify) VALUES(9, 9.49, \"Utsu-P - Greatest Shits\", 0, 1, \"10/08/2018\", 1, 1, \"https://pbs.twimg.com/media/Dno97nqW0AIuoOM.jpg:large \", \"Self-destruct, I Want to Become a Stuffed Animal, Shima Shima Melody, Imperfect Animals\", \"https://open.spotify.com/album/0irA7x2SBgb2PbCUhK5tMK?si=oDvAo0k-QUiQvGGWyFv8cQ\");                                                                \n");
                    data_sqlWriter.write("INSERT INTO Products(id, cost, product_name, quantity, genres_id_fk, date_out, author_id_fk, types_id_fk, product_image, contains, link_spotify) VALUES(10, 7.92, \"Utsu-P - Renaissance\", 0, 1, \"10/08/2019\", 1, 1, \"http://p1.music.126.net/MLtANLgzgnIkW_xV4TZQ4Q==/109951164983692215.jpg   \", \"RENAISSANCE, The Beautiful Puke, Even If Everyone Around The World Laughed\", \"https://open.spotify.com/album/0rlreh6xdNumlAQtJagDsz?si=dvT3ae-TRK-ZFLc0Zi4Qng\");                                              \n");
                    data_sqlWriter.write("INSERT INTO Products(id, cost, product_name, quantity, genres_id_fk, date_out, author_id_fk, types_id_fk, product_image, contains, link_spotify) VALUES(11, 9.49, \"Utsu-P - Unique\", 0, 1, \"23/10/2021\", 1, 1, \"https://pbs.twimg.com/media/FEu7iZNXwA4Dy-U.jpg\", \"Harakiri, Dull, PEE PEE PRINCES, March 9. 2000\", \"https://open.spotify.com/album/4i56GGeJhpNiULjGKjVP3Y?si=SqT0seyWQUysnlxupaK9yQ\");                    \n                                                        \n");
                ...
                if (doPopulateProductsAdditionalInfo.equals("true") || doPopulateAll.equals("true")) {
                    ...
                    data_sqlWriter.write("INSERT INTO products_additional_info(id, link_spotify, link_wiki, song_name, product_id_fk) VALUES (16, \"none\", \"none\", \"Children's World\", 2);\n" );
