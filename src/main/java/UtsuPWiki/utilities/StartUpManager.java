...
@Log4j2
public class StartUpManager implements ApplicationListener<ApplicationStartedEvent> {
...
//        String doPopulateAll        = event.getEnvironment().getProperty("database-helper.populate-all"      );
        ...
        String doPopulateDatabase   = "true";
        String doPopulateAuthors    = "false";
        String doPopulateClients    = "false";
        String doPopulateComments   = "false";
        String doPopulateCountries  = "false";
        String doPopulateDelivery   = "false";
        String doPopulateGenres     = "false";
        String doPopulateOrders     = "false";
        String doPopulateProducts   = "false";
        String doPopulateTypes      = "false";
        String doPopulateAll        = "true";
